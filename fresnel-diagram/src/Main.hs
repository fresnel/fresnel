...
graph = fix $ \ ~Diagram{ iso, lens, getter, prism, review, optional, affineFold, traversal, fold, setter, profunctor, strong, cochoice, bicontravariant, choice, costrong, bifunctor, closed, traversing, mapping } -> Diagram
  { iso             = optic "Iso"             (V2 0 0) (V2 (Just Max) (Just Min)) [profunctor]                      [dest lens, dest prism]
  , lens            = optic "Lens"            (V2 1 0) (V2 (Just Min) (Just Min)) [strong, iso]                     [dest optional, dest getter]
  , getter          = optic "Getter"          (V2 2 0) (V2 (Just Min) (Just Max)) [cochoice, bicontravariant, lens] [dest affineFold]
  , prism           = optic "Prism"           (V2 0 1) (V2 (Just Max) (Just Min)) [iso]                             [dest optional, dest review]
  , review          = optic "Review"          (V2 0 2) (V2 (Just Max) (Just Min)) [prism, costrong, bifunctor]      []
  , optional        = optic "Optional"        (V2 1 1) (V2 (Just Min) Nothing)    [lens, prism]                     [dest affineFold, dest traversal]
  , affineFold      = optic "AffineFold"      (V2 2 1) (V2 (Just Min) (Just Max)) [getter, optional]                [dest fold]
  , traversal       = optic "Traversal"       (V2 1 2) (V2 (Just Max) (Just Min)) [optional, traversing]            [dest fold, dest setter]
  , fold            = optic "Fold"            (V2 2 2) (V2 (Just Min) (Just Max)) [affineFold, traversal]           []
  , setter          = optic "Setter"          (V2 1 3) (V2 (Just Max) (Just Max)) [traversal, mapping]              []
  , profunctor      = klass "Profunctor"      (V2 0 0) (V2 (Just Max) (Just Min)) []                                [dest iso, offset ny strong, offset (px * 2) choice, offset py cochoice, dest costrong, offset (nx * 2) closed]
  , strong          = klass "Strong"          (V2 1 0) (V2 (Just Min) (Just Min)) [profunctor]                      [dest lens, offset px traversing]
  , cochoice        = klass "Cochoice"        (V2 2 0) (V2 (Just Min) (Just Min)) [profunctor]                      [offset px getter]
  , bicontravariant = klass "Bicontravariant" (V2 2 0) (V2 (Just Min) (Just Min)) []                                [offset nx getter]
  , choice          = klass "Choice"          (V2 0 1) (V2 (Just Max) (Just Min)) [profunctor]                      [dest prism, offset nx traversing]
  , costrong        = klass "Costrong"        (V2 0 2) (V2 (Just Max) (Just Min)) [profunctor]                      [offset py review]
  , bifunctor       = klass "Bifunctor"       (V2 0 2) (V2 (Just Max) (Just Min)) []                                [offset ny review]
  , closed          = klass "Closed"          (V2 0 3) (V2 (Just Max) (Just Min)) [profunctor]                      [dest mapping]
  , traversing      = klass "Traversing"      (V2 1 2) (V2 (Just Min) (Just Max)) [choice, strong]                  [dest traversal, dest mapping]
  , mapping         = klass "Mapping"         (V2 1 3) (V2 (Just Max) (Just Max)) [traversing, closed]              [dest setter]
  }
  where
  optic name (V2 x y) = Vertex Optic name (V3 x y 0)
  klass name (V2 x y) = Vertex Class name (V3 x y 1)
